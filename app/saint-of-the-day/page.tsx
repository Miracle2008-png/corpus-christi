      ...
      <div className="container-sacred" style={{ maxWidth: "780px", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "20px", border: "1px solid rgba(26,39,68,0.08)", overflow: "hidden", boxShadow: "0 8px 40px rgba(26,39,68,0.1)", marginBottom: "2rem" }}>
          ...
          <div style={{ padding: "2.5rem" }}>
            ...
            {saint.slug && (
              <Link href={`/saints/${saint.slug}`} style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "linear-gradient(135deg,var(--navy-dark),var(--navy))", color: "#fff", textDecoration: "none", padding: "0.75rem 1.5rem", borderRadius: "10px", fontWeight: 600, fontSize: "0.88rem" }}>
                Read Full Profile →
              </Link>
            )}
          </div>
